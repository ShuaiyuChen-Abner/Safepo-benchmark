    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.config["episode_length"]):
                ...
                reward_env = reward_env.to(self.config["device"])

                #print(f"reward_env device: {reward_env.device}, train_episode_rewards device: {train_episode_rewards.device}")
                train_episode_rewards += reward_env
                cost_env = cost_env.to(self.config["device"])
